...
fridges = Fridge.create([
        {:menu => 'Cheeseburger', :ingredient => 'Bun, patty, slice cheese', :recipe => '1. Grill patty 2. Place slice chees on top of the patty 3. Grill bun 4. Assemble all', :rating => '5', :where => 'North America'},
